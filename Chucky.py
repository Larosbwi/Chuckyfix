...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='https://github.com/Nadyatjia/AlphatTJ')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='https://github.com/Nadyatjia/AlphatTJ')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='https://github.com/Nadyatjia/AlphatTJ')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='https://github.com/Nadyatjia/AlphatTJ')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='https://github.com/Nadyatjia/AlphatTJ')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='https://github.com/Nadyatjia/AlphatTJ')
km.loginResult()
